...
Q_IMPORT_QML_PLUGIN(Tsunami_SimulatorPlugin)
Q_IMPORT_QML_PLUGIN(Tsunami_SimulatorContentPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/Tsunami_SimulatorContent/App.qml";
